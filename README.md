...
> 🌐 **Live Demo:** https://m0han8.github.io/Sales-Performance-Dashboard/

> 💻 **GitHub Repository:** https://github.com/m0han8/Sales-Performance-Dashboard
...
images/sql-insights.png
images/business-insights.png
...
git branch -M main
git remote add origin https://github.com/m0han8/Sales-Performance-Dashboard.git
...
**https://m0han8.github.io/Sales-Performance-Dashboard/**
...
- Charts, KPIs, the table, and both insights pages are all driven by `sales_data.csv` at runtime — nothing is precomputed or hardcoded.
- The project can easily be adapted to another dataset with the same column structure.
- Generative AI (Claude) was used to help scaffold the front-end code and dashboard layout; all logic and figures were reviewed and verified against the source data before publishing.
